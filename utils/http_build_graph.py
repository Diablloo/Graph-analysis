...
class GraphVisualizer:
    ...
    def add_edge(self, first_node_id, second_node_id, cve):
	    link_params = {"sourceId":first_node_id,"targetId":second_node_id,"pid":self.graph_id}
		...
		self.graph_links.append((first_node_id,second_node_id,cve))
